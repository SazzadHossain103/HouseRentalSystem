...
<head>
   ...
   <link rel="stylesheet" href="https://fontawesome.com/icons/bangladeshi-taka-sign?f=classic&s=solid">
...
<section class="listings">
   ...
   <div class="box-container">
      ...
      <form action="" method="POST">
         ...
         <div class="box">
            <div class="price"><i class="fa-solid fa-bangladeshi-taka-sign"></i><span><?= $fetch_property['price']; ?></span> TK</div>
